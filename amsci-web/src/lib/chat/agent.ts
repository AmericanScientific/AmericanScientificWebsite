...
- When a product in a list/count has a "variants" array, LIST the individual variants (SKU + label) — those are distinct, orderable items the customer wants to see. Do NOT just say "N variants" and move on; enumerate them (e.g. under the product, as a short sub-list).
